extension TDSTokenParser {
  public static func parseLoginAckToken(from buffer: inout ByteBuffer) throws
    -> TDSTokens.LoginAckToken
  {
    guard
    ...
    let token = TDSTokens.LoginAckToken(
      interface: interface, tdsVersion: tdsVersion, progName: progName, majorVer: majorVer,
      minorVer: minorVer, buildNumHi: buildNumHi, buildNumLow: buildNumLow)
