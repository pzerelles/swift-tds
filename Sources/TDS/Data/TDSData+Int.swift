...
extension TDSData {
  fileprivate init<I>(fwi: I) where I: FixedWidthInteger {
    let capacity: Int
    switch I.bitWidth {
    case 8:
      capacity = 1
  ...
  fileprivate func fwi<I>(_ type: I.Type = I.self) -> I?
  where I: FixedWidthInteger {
    ...
    case .int:
      ...
      guard let int32 = value.getInteger(at: value.readerIndex, endianness: .little, as: Int32.self)
      else {
        return nil
      }
      return I(int32)
    case .bigInt:
      ...
      guard let int64 = value.getInteger(at: value.readerIndex, endianness: .little, as: Int64.self)
      else {
        return nil
      }
      return I(int64)
    case .intn:
      ...
      case 4:
        guard
          let int32 = value.getInteger(at: value.readerIndex, endianness: .little, as: Int32.self)
        else {
          return nil
        }
        return I(int32)
      case 8:
        guard
          let int64 = value.getInteger(at: value.readerIndex, endianness: .little, as: Int64.self)
        else {
          return nil
        }
        return I(int64)
