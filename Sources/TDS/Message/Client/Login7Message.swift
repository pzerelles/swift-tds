  ...
  public struct Login7Message: TDSMessagePayload {
    ...
    public func serialize(into buffer: inout ByteBuffer) throws {
      ...
      func writeField(_ string: String, isPassword: Bool) {
        ...
        // Is that a risk?
        buffer.setInteger(
          UInt16(buffer.writerIndex - login7HeaderPosition), at: offsetLengthsPosition,
          endianness: .little)
        ...
        if isPassword {
          for character in utf16 {
            let newHighBits = (character << 4) & 0b11110000_11110000
            let newLowBits = (character >> 4) & 0b00001111_00001111
      ...
      buffer.setInteger(
        UInt32(buffer.writerIndex - login7HeaderPosition), at: login7HeaderPosition,
        endianness: .little)
      return
    }
  }
